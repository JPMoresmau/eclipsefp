...
public class ScionPlugin extends AbstractUIPlugin {
  ...
  private static final String SCION_VERSION             = "0.1.0.5";
   ...
   * 
   * @note: There has to be a better way to support plug-in singletons and
   *        instance assignment.
   */
  public ScionPlugin() {
    instance = this;
  ...
  public static IPath builtinServerDirectoryPath() {
    return instance.getStateLocation().append("scion-".concat(SCION_VERSION)); //$NON-NLS-1$
  }
