...
package de.leiffrenzel.fp.haskell.core.util;
...
/** <p>contains static helping functionality to work on file resources in the
  * workspace.</p> 
  * 
  * @author Leif Frenzel
  */
public class ResourceUtil {
  ...
  /** <p>the file extension of Haskell source files.</p> */
  public static final String EXTENSION_HS = "hs";

  /** <p>the file extension of literate Haskell source files.</p> */
  public static final String EXTENSION_LHS = "lhs";

  
  /** <p>returns whether the passed resource is a Haskell source file, as 
    * recognized by the file extensions '.hs' and '.lhs'.</p> */ 
  ...
  /** <p>returns whether the passed resource is a literate Haskell source file, 
    * as recognized by the file extension '.lhs'.</p> */ 
  public static boolean hasLiterateExtension( final IResource resource ) {
    return has( resource, EXTENSION_LHS ); 
  }
  
  /** <p>returns the target executable for the passed project as 
    * resource. The project must have the Haskell nature.</p> */ 
  ...
  /** <p>returns the output folder of the passed project as resource.
    * The project must have the Haskell nature.</p> */ 
  ...
  /** <p>returns the binary folder of the passed project as resource.
    * The project must have the Haskell nature.</p> */ 
  ...
  /** <p>returns the source folder of the passed project as resource.
    * The project must have the Haskell nature.</p> */ 
  ...
  /** <p>reads an input stream and returns the contents as String.</p> */
  public static String readStream( final InputStream is ) throws IOException {
    ...
    while( line != null ) {
      ...
      // Note: this could in some cases obscure the positions of elements in
  ...
  /** finds the corresponding resource for the specified element. This is
    * element itself, if it is an IResource, or an adapter. Returns null, 
  ...
  /** <p>returns whether the specified folder is the source folder of
    * its (Haskell) project.</p> */
