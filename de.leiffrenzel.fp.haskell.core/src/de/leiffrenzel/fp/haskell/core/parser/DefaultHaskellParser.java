...
/** <p>The default implementation for the Haskell parser. This is a dummy
  * implementation which does actually no parsing at all.</p>
  * 
  * @author Leif Frenzel
  */
class DefaultHaskellParser implements IHaskellParser {
  ...
  public ICompilationUnit parse( final IFile file ) throws CoreException {
    ...
    DummyCompilationUnit result = new DummyCompilationUnit( file );
  ...
  private IModule[] createDummyModules( final ICompilationUnit cu ) {
    return new IModule[] { new IModule() {
      ...
      public IHaskellLanguageElement getParent() {
        // modules are the top-level elements of the language element hierarchy
        // and have no parent
        return null;
      }
    } };
