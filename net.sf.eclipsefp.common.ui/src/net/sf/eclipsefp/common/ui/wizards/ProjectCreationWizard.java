...
/** <p>a wizard for creating a new project. The creation is similar
  * to a new project creation in the resource ui, but adds a nature for a 
  * specific fp feature.</p> 
  * 
  * @author Leif Frenzel 
  */
public class ProjectCreationWizard extends Wizard 
  ...
  /** Stores the configuration element for the wizard. 
    * The config element will be used in <code>performFinish</code> 
    * to set the result perspective. */
  public void setInitializationData( final IConfigurationElement configElement, 
