...
class ImplementationsBlock implements ISelectionProvider {
  ...
  void setCheckedImplementation( final IHsImplementation impl ) {
    if( impl == null ) {
  ...
  IHsImplementation getCheckedInstallation() {
    ...
    viewer.addCheckStateListener( new ICheckStateListener() {
      public void checkStateChanged( final CheckStateChangedEvent event ) {
        if( event.getChecked() ) {
          ...
          setCheckedImplementation( element );
        } else {
          setCheckedImplementation( null );
        }
      }
    } );
