...
/**
 * <p>
 * The abstract superclass for compilers.
 * </p>
 * 
 * <p>
 * Extend this class to create an FP compiler. You only have to provide specific
 * things like the command line for your compiler, the rest is handled
 * automatically.
 * </p>
 * 
 * @author Leif Frenzel
...
public abstract class AbstractHaskellCompiler implements IHaskellCompiler {
	...
	public ICompilerOutput compile(final IFile file) {
		...
		try {
			...
			StreamRedirect outRedirect = new StreamRedirect(
															"output_redirect",
															proc
																	.getInputStream(),
															output);
			StreamRedirect errRedirect = new StreamRedirect(
															"error_redirect",
															proc
																	.getErrorStream(),
															errors);
