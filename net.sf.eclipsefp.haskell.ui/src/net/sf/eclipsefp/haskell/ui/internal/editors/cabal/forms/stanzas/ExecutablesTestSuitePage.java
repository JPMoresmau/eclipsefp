...
public abstract class ExecutablesTestSuitePage extends CabalFormPage implements IFormEntryListener, SelectionListener {
  ...
  public ExecutablesTestSuitePage( final FormEditor editor, final IProject project, final String title ) {
    super( editor, ExecutablesTestSuitePage.class.getName(), title, project );
  }

  public abstract String getMessage(Messages m);

  public abstract PackageDescriptionStanza createNewStanza(final PackageDescription desc, final String name);

  public abstract java.util.List<PackageDescriptionStanza> getStanzas(final PackageDescription description);
  ...
  protected void createFormContent( final IManagedForm managedForm ) {
    ...
    form.updateToolBar();
    form.setText( getMessage(Messages.TITLE) );
    ...
    addButton.addSelectionListener( new SelectionAdapter() {
      ...
      public void widgetSelected( final SelectionEvent e ) {
        InputDialog dialog = new InputDialog( execsList.getShell(),
            ...
            "", new IInputValidator() {
              ...
              public String isValid( final String newText ) {
                ...
                if (value.length()==0) {
                  return getMessage(Messages.BLANK_ERROR);
                }
                for (String s : execsList.getItems()) {
                  if (s.equals( value )) {
                    return getMessage(Messages.ALREADY_EXISTS_ERROR);
                  }
                }
                return null;
              }
        ...
        if (dialog.open() == Window.OK) {
          ...
          PackageDescriptionStanza execStanza = createNewStanza( lastDescription, execName );
