...
public final class UITexts extends NLS {
  ...
  public static String resolve_import_add_everything;
  ...
  public static String resolve_set_cabalfield;
  ...
  public static String install_sandbox_title;
  ...
  public static String cabalEditor_dependencyVersionFromMajor;
  ...
  public static String cabalEditor_newBenchmarkString;
  public static String cabalEditor_newBenchmarkBlankError;
  public static String cabalEditor_newBenchmarkAlreadyExistsError;
  ...
  public static String worksheet_removeallexpressions_title;
