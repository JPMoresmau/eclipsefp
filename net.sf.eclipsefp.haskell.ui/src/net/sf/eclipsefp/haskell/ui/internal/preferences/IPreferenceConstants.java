...
//  public final static String SCION_BROWSER_SERVER_BUILTIN = "SCION_BROWSER_SERVER_BUILTIN" ; //$NON-NLS-1$
  ...
  public final static String BROWSER_START_ONLY_PERSPECTIVE= "SCION_BROWSER_START_ONLY_PERSPECTIVE"; //$NON-NLS-1$
  ...
  public final static String MANAGE_DEPENDENCIES="MANAGE_DEPENDENCIES"; //$NON-NLS-1$
  /**
   * Source-graph
   */
